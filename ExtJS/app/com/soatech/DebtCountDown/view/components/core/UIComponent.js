/**
 * @lends DebtCountDown.view.components.core.UIComponent.prototype
 */
Ext.namespace('DebtCountDown.view.components.core');
DebtCountDown.view.components.core.UIComponent = Ext.extend(Ext.util.Observable, {
  /**
   ...
   * @author Tony DeFusco
   *
   * @see DebtCountDown.view.components.Box
   * @see DebtCountDown.view.components.ControlPanel
   * @see DebtCountDown.view.components.Shell
   * @see DebtCountDown.view.components.WorldSpace
   *
   * @constructs
   */
  constructor: function(element /* String/Ext.Element */, config /* Object */, styles /* Object */) {
    if (element) {
      this.element = DebtCountDown.view.components.core.UIComponent.buildElement(element, styles);
    }
    if (config) {
      if (config.events) {
      ...
      DebtCountDown.view.components.core.UIComponent.superclass.constructor.call(this, config);
    }
    else {
      DebtCountDown.view.components.core.UIComponent.superclass.constructor.call(this);
    }
  },
   ...
   * @param {DebtCountDown.view.components.core.UIComponent} child The child component to append.
   *
   * @return this object - can be used for method/property chaining.
   * @type DebtCountDown.view.components.core.UIComponent
   */
...
Ext.apply(DebtCountDown.view.components.core.UIComponent, {
  /**
   ...
   * style the underlying Ext.Element.
   *
   * @memberof DebtCountDown.view.components.core.UIComponent
   */
  ...
  buildComponent: function(element, styles) {
    var el = DebtCountDown.view.components.core.UIComponent.buildElement(element, styles);
    var component = new DebtCountDown.view.components.core.UIComponent(el);
    return component;
  }
});