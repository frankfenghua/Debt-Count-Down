package com.soatech.debtcountdown.commands
{
	...
	public class PlanLinkBudgetItemCommand extends Command implements IResponder
	{
		//---------------------------------------------------------------------
		//
		// Properties
		...
		{
			planService.linkBudgetItem(planProxy.selectedPlan, event.budgetItem, this);
		}
		...
		{
			CONFIG::debugtrace{ trace("PlanLinkBudgetItemCommand::fault - " + info.toString()); }
		}
	}
}